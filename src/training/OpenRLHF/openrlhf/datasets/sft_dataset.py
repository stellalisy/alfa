...
def preprocess_data(data, input_template=None, input_key="input", output_key=None, apply_chat_template=None, pretrain_mode=False):
    if apply_chat_template:
        if output_key:
            ...
            response = apply_chat_template(prompt_message + response_message, tokenize=False, add_generation_prompt=False)[len(prompt) :]
        else:
