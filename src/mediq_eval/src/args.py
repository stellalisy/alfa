...
def get_args():
    ...
    parser.add_argument('--expert_model_question_generator', type=str, default='meta-llama/Llama-3.1-8B-Instruct', help='Expert model name to use for the benchmark, can be a local model or a Huggingface model.')
    ...
    parser.add_argument('--abstain_threshold', type=float, default=None, help='Threshold for abstaining from making a choice.')
    ...
    parser.add_argument('--healthQ_eval', action='store_true', help='Specialized question generator details for benchmarking the HealthQ project')
    parser.add_argument('--healthQ_use_original_post_as_initial_info', action='store_true', help='Specialized question generator details for benchmarking the HealthQ project')
    parser.add_argument('--healthQ_no_system_prompt', action='store_true', help='Specialized question generator details for benchmarking the HealthQ project')
    ...
    args.num_diff_models = len(set([args.expert_model, args.expert_model_question_generator, args.patient_model]))
    return args