...
class Expert:
    ...
    def ask_question(self, patient_state, prev_messages):
        ...
        kwargs = {
            ...
            "no_system_prompt": self.args.healthQ_no_system_prompt,
            "num_diff_models": self.args.num_diff_models
        }
        if self.args.healthQ_eval: return expert_functions.question_generation_healthQ(**kwargs)
