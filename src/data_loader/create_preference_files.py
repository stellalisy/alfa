...
def build_counterfactual_pairs(data, features=["accuracy", "avoidbias", "relevance", "clarity", "focus", "answerability"]):
    """
...
output_filepath = f"counterfactual_questions/train.jsonl"
split_save_data(data_file=input_filepath, output_file=output_filepath, write=False)

input_filepath = f"counterfactual_questions/eval_counterfactuals.jsonl"
output_filepath = f"counterfactual_questions/validation.jsonl"
split_save_data(data_file=input_filepath, output_file=output_filepath, write=False)